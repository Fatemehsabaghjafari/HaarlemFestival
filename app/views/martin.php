...
<img class="headPic" src="/img/martinG.png" alt="nicky">
    ...
    <p class="artCultureHeadP"> Immerse yourself in Martin Garrix's dynamic beats and captivating melodies, where each track is a thrilling experience of energy and emotion. From the iconic "Animals" to soulful collaborations like "Don’t look down" his music is a vibrant journey that will ignite your passion for electronic beats.</p> 
    ...
    <div class="topSongContainer">
        <div class="content">
            ...
            <p class="highlightsP">"Animals" Breakthrough (2013): Garrix rose to fame with the iconic track "Animals," solidifying his position as a leading force in electronic music.

Global Chart Success: Continual chart-topping hits showcased Garrix's enduring influence in the electronic music scene.

A-List Collaborations: Collaborations with Usher, Dua Lipa, and Khalid expanded his musical reach, contributing to the crossover success of electronic music.
            </p>
        </div>
    </div>
       <?php
